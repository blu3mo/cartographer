...
export function SessionAdminDashboard({
  ...
  if (isUserIdLoading || loading) {
    return (
      <div className={embedded ? "bg-transparent" : "min-h-screen bg-slate-50"}>
        {!embedded && <AppHeader />}
        <div
          className={embedded ? "px-6 py-6" : "max-w-6xl mx-auto px-6 py-10"}
        >
  ...
  if (error) {
    return (
      <div className={embedded ? "bg-transparent" : "min-h-screen bg-slate-50"}>
        {!embedded && <AppHeader />}
        <div
          className={`${embedded ? "" : "max-w-6xl mx-auto "}px-6 py-10 space-y-8`}
        >
          {!embedded && <AdminBreadcrumb sessionTitle={breadcrumbTitle} />}
  ...
  return (
    <div className={embedded ? "bg-transparent" : "min-h-screen bg-slate-50"}>
      {!embedded && <AppHeader />}
      <div
        className={`${embedded ? "" : "max-w-[90rem] mx-auto "}px-6 py-10 space-y-10`}
      >
