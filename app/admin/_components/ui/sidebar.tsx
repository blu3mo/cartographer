...
import { useIsMobile } from "@/admin/_components/hooks/use-mobile";
import { Separator } from "@/admin/_components/ui/separator";
import {
  Sheet,
  SheetContent,
  SheetDescription,
  SheetHeader,
  SheetTitle,
} from "@/admin/_components/ui/sheet";
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
  TooltipTrigger,
} from "@/admin/_components/ui/tooltip";
...
function SidebarProvider({
  ...
  const persistSidebarState = React.useCallback((value: boolean) => {
